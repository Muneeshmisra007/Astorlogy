...
public class ScorpioOctober extends Activity implements SimpleGestureListener{
	private com.astro.swipe.SimpleGestureFilter detector;


//	String astro[] = {R.string.scorpio_oct
//	};

	String horo_name[] ={"Scorpio"};
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		HoroName.setText(R.string.scorpio_monthly);
		Desc.setText(R.string.scorpio_oct);
		image.setImageResource(R.drawable.scorpius_text_icon);
		...
		arrow1.setOnClickListener(new OnClickListener(){
			...
			public void onClick(View v) {
				// TODO Auto-generated method stub
				Intent i = new Intent(getApplicationContext(),ScorpioSeptember.class);
				startActivity(i);
		...
		arrow2.setOnClickListener(new OnClickListener(){
			...
			public void onClick(View v) {
				// TODO Auto-generated method stub
				Intent ii = new Intent(getApplicationContext(),ScorpioNovember.class);
				startActivity(ii);
	...
	public void onBackPressed() {
		Intent menu = new Intent(getApplicationContext(),ScorpioMonthly.class);
		startActivity(menu);
	}
