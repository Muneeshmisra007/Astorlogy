...
public class VirgoJuly extends Activity implements SimpleGestureListener{
	private com.astro.swipe.SimpleGestureFilter detector;

//
//	String astro[] = {R.string.virgo_jul
//	};
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		Desc.setText(R.string.virgo_jul);
		...
		arrow1.setOnClickListener(new OnClickListener(){
			...
			public void onClick(View v) {
				// TODO Auto-generated method stub
				Intent i = new Intent(getApplicationContext(),VirgoJune.class);
				startActivity(i);
		...
		arrow2.setOnClickListener(new OnClickListener(){
			...
			public void onClick(View v) {
				// TODO Auto-generated method stub
				Intent ii = new Intent(getApplicationContext(),VirgoAugust.class);
				startActivity(ii);
