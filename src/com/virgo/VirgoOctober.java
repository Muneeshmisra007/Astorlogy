...
public class VirgoOctober extends Activity implements SimpleGestureListener{
	private com.astro.swipe.SimpleGestureFilter detector;


//	String astro[] = {R.string.virgo_oct
//	};

	String horo_name[] ={"Virgo"};
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		HoroName.setText(R.string.virgo_monthly);
		Desc.setText(R.string.virgo_oct);
		image.setImageResource(R.drawable.virgo_text_icon);
		...
		arrow1.setOnClickListener(new OnClickListener(){
			...
			public void onClick(View v) {
				// TODO Auto-generated method stub
				Intent i = new Intent(getApplicationContext(),VirgoSeptember.class);
				startActivity(i);
		...
		arrow2.setOnClickListener(new OnClickListener(){
			...
			public void onClick(View v) {
				// TODO Auto-generated method stub
				Intent ii = new Intent(getApplicationContext(),VirgoNovember.class);
				startActivity(ii);
	...
	public void onBackPressed() {
		Intent menu = new Intent(getApplicationContext(),VirgoMonthly.class);
		startActivity(menu);
	}
