...
public class AquariusSeptember extends Activity implements
		SimpleGestureListener {
	private com.astro.swipe.SimpleGestureFilter detector;

	//String astro[] = { R.string.aquarius_sept };
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		String udata= getString(R.string.september_ap);
		...
		Desc.setText(R.string.aquarius_sept);
		...
		arrow1.setOnClickListener(new OnClickListener(){
			...
			public void onClick(View v) {
				// TODO Auto-generated method stub
				Intent i = new Intent(getApplicationContext(), AquariusAugust.class);
				startActivity(i);
