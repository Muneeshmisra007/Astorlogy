...
public class AquariusMay extends Activity implements SimpleGestureListener{
	private com.astro.swipe.SimpleGestureFilter detector;


//	String astro[] = {"This month will be little trouble some in family and financial matter but busyness in business will be there. Due to excessive involvements chances of hidden losses may be there."
//	};
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		String udata= getString(R.string.may_ap);
		...
		Desc.setText(R.string.aquarius_may);
		...
		arrow1.setOnClickListener(new OnClickListener(){
			...
			public void onClick(View v) {
				// TODO Auto-generated method stub
				Intent i = new Intent(getApplicationContext(),AquariusApril.class);
				startActivity(i);
		...
		arrow2.setOnClickListener(new OnClickListener(){
			...
			public void onClick(View v) {
				// TODO Auto-generated method stub
				Intent ii = new Intent(getApplicationContext(),AquariusJune.class);
				startActivity(ii);
