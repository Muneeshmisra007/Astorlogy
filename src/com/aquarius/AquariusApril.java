...
public class AquariusApril extends Activity implements SimpleGestureListener{
	...
	protected void onCreate(Bundle savedInstanceState) {
	  ...
	  //HoroName.setTypeface(tf1);
		...
		Desc.setText(R.string.aquaris_apr);
		...
		arrow1.setOnClickListener(new OnClickListener(){
			...
			public void onClick(View v) {
				// TODO Auto-generated method stub
				Intent i = new Intent(getApplicationContext(),AquariusMarch.class);
				startActivity(i);
		...
		arrow2.setOnClickListener(new OnClickListener(){
			...
			public void onClick(View v) {
				// TODO Auto-generated method stub
				Intent ii = new Intent(getApplicationContext(),AquariusMay.class);
				startActivity(ii);
