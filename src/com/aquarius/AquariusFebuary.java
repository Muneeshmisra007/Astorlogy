...
public class AquariusFebuary extends Activity implements SimpleGestureListener {
	private com.astro.swipe.SimpleGestureFilter detector;

	// String astro[] = {R.string.aquarius_feb};

	String horo_name[] = { "Aquarius" };
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		String udata= getString(R.string.febuary_ap);
		...
		HoroName.setText(R.string.aquarius_monthly);
		Desc.setText(R.string.aquarius_feb);
		image.setImageResource(R.drawable.aquarius_text_icon);
		...
		arrow2.setOnClickListener(new OnClickListener(){
			...
			public void onClick(View v) {
				// TODO Auto-generated method stub
				Intent ii = new Intent(getApplicationContext(), AquariusMarch.class);
				startActivity(ii);
	...
	public void onBackPressed() {
		Intent menu = new Intent(getApplicationContext(), AquariusMonthly.class);
		startActivity(menu);
		finish();
	}
