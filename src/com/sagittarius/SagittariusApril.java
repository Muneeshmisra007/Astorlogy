...
public class SagittariusApril extends Activity implements SimpleGestureListener{
	private com.astro.swipe.SimpleGestureFilter detector;


//	String astro[] = {R.string.sagittarius_apr
//	};
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		String udata= getString(R.string.april_ap);
		...
		Desc.setText(R.string.sagittarius_apr);
		...
		arrow1.setOnClickListener(new OnClickListener(){
			...
			public void onClick(View v) {
				// TODO Auto-generated method stub
				Intent i = new Intent(getApplicationContext(),SagittariusMarch.class);
				startActivity(i);
		...
		arrow2.setOnClickListener(new OnClickListener(){
			...
			public void onClick(View v) {
				// TODO Auto-generated method stub
				Intent ii = new Intent(getApplicationContext(),SagittariusMay.class);
				startActivity(ii);
