...
public class SagittariusOctober extends Activity implements SimpleGestureListener{
	private com.astro.swipe.SimpleGestureFilter detector;


//	String astro[] = {R.string.sag_oct
//	};

	String horo_name[] ={"Sagittarius"};
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		String udata= getString(R.string.october_ap);
		...
		HoroName.setText(R.string.sagittarius_monthly);
		Desc.setText(R.string.sag_oct);
		image.setImageResource(R.drawable.sagittarius_text_icon);
		...
		arrow1.setOnClickListener(new OnClickListener(){
			...
			public void onClick(View v) {
				// TODO Auto-generated method stub
				Intent i = new Intent(getApplicationContext(),SagittariusSeptember.class);
				startActivity(i);
		...
		arrow2.setOnClickListener(new OnClickListener(){
			...
			public void onClick(View v) {
				// TODO Auto-generated method stub
				Intent ii = new Intent(getApplicationContext(),SagittariusNovember.class);
				startActivity(ii);
	...
	public void onBackPressed() {
		Intent menu = new Intent(getApplicationContext(),SagittariusMonthly.class);
		startActivity(menu);
	}
