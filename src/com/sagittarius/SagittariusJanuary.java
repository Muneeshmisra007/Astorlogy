...
public class SagittariusJanuary extends Activity implements SimpleGestureListener{
	private com.astro.swipe.SimpleGestureFilter detector;


//	String astro[] = {R.string.sag_jan
//	};
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		String udata= getString(R.string.january_ap);
		...
		arrow1.setOnClickListener(new OnClickListener(){
			...
			public void onClick(View v) {
				// TODO Auto-generated method stub
				Intent i = new Intent(getApplicationContext(),SagittariusDecember.class);
				startActivity(i);
		...
		arrow2.setOnClickListener(new OnClickListener(){
			...
			public void onClick(View v) {
				// TODO Auto-generated method stub
				Intent ii = new Intent(getApplicationContext(),SagittariusFebuary.class);
				startActivity(ii);
