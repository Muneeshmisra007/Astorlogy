...
public class PiscesOctober extends Activity implements SimpleGestureListener{
	private com.astro.swipe.SimpleGestureFilter detector;

//
//	String astro[] = {R.string.pisces_oct
//	};

	String horo_name[] ={"Pisces"};
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		HoroName.setText(R.string.pisces_monthly);
		Desc.setText(R.string.pisces_oct);
		image.setImageResource(R.drawable.pisces_text_icon);
		...
		arrow1.setOnClickListener(new OnClickListener(){
			...
			public void onClick(View v) {
				// TODO Auto-generated method stub
				Intent i = new Intent(getApplicationContext(),PiscesSeptember.class);
				startActivity(i);
		...
		arrow2.setOnClickListener(new OnClickListener(){
			...
			public void onClick(View v) {
				// TODO Auto-generated method stub
				Intent ii = new Intent(getApplicationContext(),PiscesNovember.class);
				startActivity(ii);
	...
	public void onBackPressed() {
		Intent menu = new Intent(getApplicationContext(),PiscesMonthly.class);
		startActivity(menu);
	}
