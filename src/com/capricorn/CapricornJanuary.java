...
public class CapricornJanuary extends Activity implements SimpleGestureListener{
	private com.astro.swipe.SimpleGestureFilter detector;


//	String astro[] = {R.string.capricorn_jan
//	};
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		Desc.setText(R.string.capricorn_jan);
		...
		arrow1.setOnClickListener(new OnClickListener(){
			...
			public void onClick(View v) {
				// TODO Auto-generated method stub
				Intent i = new Intent(getApplicationContext(),CapricornDecember.class);
				startActivity(i);
		...
		arrow2.setOnClickListener(new OnClickListener(){
			...
			public void onClick(View v) {
				// TODO Auto-generated method stub
				Intent ii = new Intent(getApplicationContext(),CapricornFebuary.class);
				startActivity(ii);
