...
public class CapricornMay extends Activity implements SimpleGestureListener{
	private com.astro.swipe.SimpleGestureFilter detector;

//
//	String astro[] = {R.string.capricorn_may
//	};
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		Desc.setText(R.string.capricorn_may);
		...
		arrow1.setOnClickListener(new OnClickListener(){
			...
			public void onClick(View v) {
				// TODO Auto-generated method stub
				Intent i = new Intent(getApplicationContext(),CapricornApril.class);
				startActivity(i);
		...
		arrow2.setOnClickListener(new OnClickListener(){
			...
			public void onClick(View v) {
				// TODO Auto-generated method stub
				Intent ii = new Intent(getApplicationContext(),CapricornJune.class);
				startActivity(ii);
