...
public class CancerOctober extends Activity implements SimpleGestureListener{
	private com.astro.swipe.SimpleGestureFilter detector;


//	String astro[] = {R.string.cancer_oct
//	};

	String horo_name[] ={"Cancer"};
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		HoroName.setText(R.string.cancer_monthly);
		Desc.setText(R.string.cancer_oct);
		image.setImageResource(R.drawable.cancer_text_icon);
		...
		arrow1.setOnClickListener(new OnClickListener(){
			...
			public void onClick(View v) {
				// TODO Auto-generated method stub
				Intent i = new Intent(getApplicationContext(),CancerSeptember.class);
				startActivity(i);
		...
		arrow2.setOnClickListener(new OnClickListener(){
			...
			public void onClick(View v) {
				// TODO Auto-generated method stub
				Intent ii = new Intent(getApplicationContext(),CancerNovember.class);
				startActivity(ii);
	...
	public void onBackPressed() {
		Intent menu = new Intent(getApplicationContext(),CancerMonthly.class);
		startActivity(menu);
	}
