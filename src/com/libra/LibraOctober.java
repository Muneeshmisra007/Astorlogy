...
public class LibraOctober extends Activity implements SimpleGestureListener{
	private com.astro.swipe.SimpleGestureFilter detector;


//	String astro[] = {R.string.libra_oct
//	};

	String horo_name[] ={"Libra"};
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		HoroName.setText(R.string.libra_monthly);
		Desc.setText(R.string.libra_oct);
		image.setImageResource(R.drawable.libra_text_icon);
		...
		arrow1.setOnClickListener(new OnClickListener(){
			...
			public void onClick(View v) {
				// TODO Auto-generated method stub
				Intent i = new Intent(getApplicationContext(),LibraSeptember.class);
				startActivity(i);
		...
		arrow2.setOnClickListener(new OnClickListener(){
			...
			public void onClick(View v) {
				// TODO Auto-generated method stub
				Intent ii = new Intent(getApplicationContext(),LibraNovember.class);
				startActivity(ii);
	...
	public void onBackPressed() {
		Intent menu = new Intent(getApplicationContext(),LibraMonthly.class);
		startActivity(menu);
	}
