...
public class LeoAugust extends Activity implements SimpleGestureListener {
	private com.astro.swipe.SimpleGestureFilter detector;

//	String astro[] = { R.string.leo_aug };

	String horo_name[] = { "Leo" };
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		tf1 = Typeface.createFromAsset(getBaseContext().getAssets(), "font/"
				+ "snell.ttf");
		tf2 = Typeface.createFromAsset(getBaseContext().getAssets(), "font/"
				+ "sourcebold.otf");
		...
		String udata= getString(R.string.august_ap);
		...
		HoroName.setText(R.string.leo_monthly);
		Desc.setText(R.string.leo_aug);
		image.setImageResource(R.drawable.leo_text_icon);
		...
		arrow1.setOnClickListener(new OnClickListener(){
			...
			public void onClick(View v) {
				// TODO Auto-generated method stub
				Intent i = new Intent(getApplicationContext(), LeoJuly.class);
				startActivity(i);
		...
		arrow2.setOnClickListener(new OnClickListener(){
			...
			public void onClick(View v) {
				// TODO Auto-generated method stub
				Intent ii = new Intent(getApplicationContext(), LeoSeptember.class);
				startActivity(ii);
	...
	public void onBackPressed() {
		Intent menu = new Intent(getApplicationContext(), LeoMonthly.class);
		startActivity(menu);
	}
	...
	public boolean onOptionsItemSelected(MenuItem item) {
		...
		case R.id.friend:
			try {
				...
				sAux = sAux
						+ "https://play.google.com/store/apps/details?id=com.appsbazaar.astrology&hl=en\n\n";
		...
		case R.id.more:
			...
			// Uri.parse("https://play.google.com/store/apps/developer?id=AppsBazaar")));
			Intent j = new Intent(getApplicationContext(),
					applist.MainActivity.class);
			startActivity(j);
			break;
		case R.id.feedback:
