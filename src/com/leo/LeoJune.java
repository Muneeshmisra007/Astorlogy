...
public class LeoJune extends Activity implements SimpleGestureListener{
	private com.astro.swipe.SimpleGestureFilter detector;

//
//	String astro[] = {R.string.leo_jun
//	};
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		arrow1.setOnClickListener(new OnClickListener(){
			...
			public void onClick(View v) {
				// TODO Auto-generated method stub
				Intent i = new Intent(getApplicationContext(),LeoMay.class);
				startActivity(i);
		...
		arrow2.setOnClickListener(new OnClickListener(){
			...
			public void onClick(View v) {
				// TODO Auto-generated method stub
				Intent ii = new Intent(getApplicationContext(),LeoJuly.class);
				startActivity(ii);
